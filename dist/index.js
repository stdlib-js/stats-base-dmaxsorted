...
});var m=n(function(g,d){
var q=require('@stdlib/math-base-assert-is-nan/dist'),c=require('@stdlib/math-base-assert-is-positive-zero/dist');function P(t,e,u,i){var r,a;return t<=0?NaN:t===1||u===0?e[0]:(r=e[i],a=e[i+(t-1)*u],q(r)||q(a)?NaN:r===a?c(r)||c(a)?0:r:r>a?r:a)}d.exports=P
});var N=n(function(h,y){
var Z=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),p=o(),x=m();Z(p,"ndarray",x);y.exports=p
